...
(function() {    
    ...
    MarkerTool.prototype._bind = function(){
        ...
        me._clickHandler = function(evt){
            ...
            //FIXME, remove the already exit marker, so only one marker allowed @2014/08/27
            if(me['marker']) me._map.removeOverlay(me['marker']);
            ...
            //FIXME, remember the newly created marker;
            me['marker'] = mkr;
