{capture name="mainbox"}
    ...
    <form action="{""|fn_url}" method="post" name="manage_products_form">
        ...
        {if $products}
            <table width="100%" class="table table-middle">
                ...
                <tr>
                    ...
                    <th width="5%">Action</th><!--add title-->
                ...
                {foreach from=$products item=product}
                    ...
                    <tr class="cm-row-status-{$product.status|lower} {$hide_inputs_if_shared_product}">
                        ...
                        <td class="center nowrap">
                            {if !empty($runtime.company_id)}{* vendor not allowed to active product! *}
                                {include file="common/select_popup.tpl" popup_additional_class="dropleft" id=$product.product_id status=$product.status hidden=true object_id_name="product_id" table="products" display="text"}
                            {else}
        ...
        {capture name="select_fields_to_edit"}{* open dialog while click popup menu item *}
        ...
        {/capture}{* end of select_fields_to_edit *}
