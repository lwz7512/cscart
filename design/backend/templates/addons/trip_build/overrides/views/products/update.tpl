{capture name="mainbox"}
    ...
    {capture name="tabsbox"}
        ...
        <form id='form' action="{""|fn_url}" method="post" name="product_update_form" class="form-horizontal form-edit  cm-disable-empty-files {if ""|fn_check_form_permissions || ($runtime.company_id && $product_data.shared_product == "Y" && $product_data.company_id != $runtime.company_id)} cm-hide-inputs{/if}" enctype="multipart/form-data"> {* product update form *}
            ...
            <div class="product-manage" id="content_detailed">
                ...
                <div id="acc_information" class="collapse in">
                    ...
                    <div class="control-group {$no_hide_input_if_shared_product}"><!--product name-->
                        <label for="product_description_product" class="control-label cm-required">{__("name")}</label>
                        <div class="controls">
                            <input class="input-large" form="form" type="text" id="product_description_product" name="product_data[product]" value="{$product_data.product}" />
                            {include file="buttons/update_for_all.tpl" display=$show_update_for_all object_id='product' name="update_all_vendors[product]"}
                        </div>
                    </div>

                    <div class="control-group {$no_hide_input_if_shared_product}"><!--product short description-->
                        <label for="elm_product_short_descr" class="control-label cm-required">{__("short_description")}:</label>
                        <div class="controls">
                            <input class="input-large" form="form" type="text" id="elm_product_short_descr" name="product_data[short_description]" value="{$product_data.short_description}" />
                    ...
                    <div class="control-group cm-no-hide-input"><!---->
                        <label for="elm_product_full_descr" class="control-label cm-required">{__("full_description")}:</label>
                        <div class="controls">
        ...
        <div id="content_addons">
            ...
            {hook name="products:tabs_content"}{/hook}
    ...
    {/capture}{* end of tabsbox *}

    {include file="common/tabsbox.tpl"
        content=$smarty.capture.tabsbox
        group_name=$runtime.controller
        active_tab=$smarty.request.selected_section track=true}

{/capture}{* end of mainbox *}
